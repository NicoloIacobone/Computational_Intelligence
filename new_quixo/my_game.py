...
class MyGame(Game):
    ...
    # def compute_available_moves(self):
    #     ''' Compute all possible moves in this state '''
    #     neutral_moves = [] # list of neutral moves in a given state
    #     winning_moves = [] # list of winning moves in a given state
    #     losing_moves = [] # list of losing moves in a given state
    #     old_board = self._board.copy() # save the old board to restore it after testing a move
    ...
    #                     if possible_move: # if the move is possible
    #                         if winner == -1:
    #                             neutral_moves.append(((row, col), move)) # add the move to the list of neutral moves
    #                         elif winner == self.current_player_idx:
    #                             winning_moves.append(((row, col), move)) # add the move to the list of winning moves
    #                         else:
    #                             losing_moves.append(((row, col), move)) # add the move to the list of losing moves

    #     return neutral_moves, winning_moves, losing_moves # return the list of available moves
